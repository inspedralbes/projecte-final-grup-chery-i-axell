 ...
 */
class getTipusRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TipusRepository' shared autowired service.
     *
     * @return \App\Repository\TipusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TipusRepository.php';

        return $container->privates['App\\Repository\\TipusRepository'] = new \App\Repository\TipusRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
